...
;JessieJamesData:
	db 14,EKANS,GARFIELD,KOFFING,0
	db 25,KOFFING,GARFIELD,EKANS,0
	db 27,GARFIELD,ARBOK,WEEZING,0
	db 31,WEEZING,ARBOK,GARFIELD,0
...
LtSurgeData:
	db $FF,28,RAICHU,0
ErikaData:
	db $FF,30,TANGELA,32,ROSELIA,32,GLOOM,0
KogaData:
