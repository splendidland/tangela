...
;ROSELIA
;Evolutions
	db EV_ITEM,LEAF_STONE,1,ROSERADE
	db 0
;Learnset
	db 15,POISONPOWDER
	db 17,STUN_SPORE
...
;LOMBRE
;Evolutions
	db EV_ITEM,WATER_STONE,1,LUDICOLO
;Learnset
	db 20,MEGA_DRAIN
	db 0
...
;Evolutions
	...
	db EV_ITEM,MOON_STONE,1,GARFIELD
	db 0
;Learnset
	db 12,BITE
	db 17,PAY_DAY
