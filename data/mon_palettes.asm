MonsterPalettes:
	...
	db PAL_CYANMON   ; NIHILEGO
	db PAL_GREYMON   ; XURKITREE
	db PAL_GREENMON  ; CELESTEELA
	db PAL_MEWMON    ; THREEMAN
	db PAL_REDMON    ; GARFIELD
	db PAL_BLUEMON   ; RAMIEL